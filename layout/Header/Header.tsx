  ...
  return (
    <header className={cn(className, styles.header)} {...props}>
      <div className={styles.leftpartnav}>
        ...
        <ReactIcon className={cn(styles.leftpartnavicons, styles.circleIcon)} />
        <ReduxIcon className={cn(styles.leftpartnavicons, styles.circleIcon)} />
        <NextIcon className={cn(styles.leftpartnavicons, styles.circleIcon)} />
      </div>
